...
(function() {
    ...
    if (selectNavbar) {
        let navbarOffset = selectNavbar.offsetTop
        let nextElement = selectNavbar.nextElementSibling
        const navbarFixed = () => {
            if ((navbarOffset - window.scrollY) <= 0) {
        ...
        window.addEventListener('load', navbarFixed)
        onscroll(document, navbarFixed)
    }
